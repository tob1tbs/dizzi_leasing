    ...
    (u.ClassNavMenu = function () {
        ...
        (u.TGL.expand = function (t, e) {
            ...
            p(n).on("click", function (t) {
                u.Toggle.trigger(p(this).data("target"), i), t.preventDefault();
            });
        }),
        (u.TGL.ddmenu = function (t, e) {
            var n = t || ".nk-menu-toggle",
                ...
                i = e ? f(t, e) : t;
            p(n).on("click", function (t) {
                u.Win.width < d.lg && u.Toggle.dropMenu(p(this), i), t.preventDefault();
            });
        }),
        (u.TGL.showmenu = function (t, e) {
            var n = p(t || ".nk-nav-toggle"),
                i = p("[data-content]"),
                a = i.hasClass(r) ? d.lg : d.xl,
                t = { active: "toggle-active", content: s + "-active", body: "nav-shown", overlay: "nk-header-overlay", break: a, close: { profile: !0, menu: !1 } },
                o = e ? f(t, e) : t;
            n.on("click", function (t) {
                u.Toggle.trigger(p(this).data("target"), o), t.preventDefault();
            }),
                l.on("mouseup", function (t) {
                    !n.is(t.target) && 0 === n.has(t.target).length && !i.is(t.target) && 0 === i.has(t.target).length && u.Win.width < a && u.Toggle.removed(n.data("target"), o);
                }),
                c.on("resize", function () {
                    (u.Win.width < d.xl || u.Win.width < a) && u.Toggle.removed(n.data("target"), o);
                });
        }),
        ...
        (u.Dropzone = function (i, a) {
            p(i).exists() &&
                p(i).each(function () {
                    var t = (t = p(i).data("max-files")) || null,
                        e = (e = p(i).data("max-file-size")) || 256,
                        n = p(i).data("accepted-files"),
            ...
            p(t).exists() &&
                p(t).each(function () {
                    var t = p(this).data("auto-responsive"),
                        ...
                        i = e ? '<"dt-export-buttons d-flex align-center"<"dt-export-title d-none d-md-inline-block">B>' : "",
                        a = e ? " with-export" : "",
                        e =
                        ...
                        e = {
                            responsive: !0,
                            autoWidth: !1,
                            dom: p(this).hasClass("is-separate") ? i : e,
                            language: {
                                search: "",
        ...
        (u.DataTable.init = function () {
            u.DataTable(".datatable-init", { responsive: { details: !0 } }), u.DataTable(".datatable-init-export", { responsive: { details: !0 }, buttons: ["copy", "excel", "csv", "pdf"] }), (p.fn.DataTable.ext.pager.numbers_length = 7);
        }),
        ...
        (u.ModeSwitch = function () {
            ...
            i.hasClass("dark-mode") ? t.addClass("active") : t.removeClass("active"),
                t.on("click", function (t) {
                    t.preventDefault(), p(this).toggleClass("active"), i.toggleClass("dark-mode");
                });
        }),
        (u.Knob = function (t, e) {
            var n, i;
            ...
            p(t).exists() &&
                ...
                p(t).each(function () {
                    var t = p(this),
                        ...
                        i = t.data("connect"),
                        i = void 0 === (i = /\s/g.test(i) ? i.split(" ") : i) ? "lower" : i,
                        a = (a = t.data("min")) || 0,
                        o = (o = t.data("max")) || 100,
                    ...
                    console.log(t);
                    (e = document.getElementById(e)), (t = { start: n, connect: i, direction: u.State.isRTL ? "rtl" : "ltr", range: { min: a, max: o }, margin: s, limit: r, step: c, orientation: l, tooltips: t }), (t = d ? f(t, d) : t);
        ...
        (u.Picker.init = function () {
            u.Picker.date(".date-picker"), u.Picker.dob(".date-picker-alt"), u.Picker.time(".time-picker"), u.Picker.date(".date-picker-range", { todayHighlight: !1, autoclose: !1 });
        }),
        (u.Addons.Init = function () {
            u.Knob.init(), u.Range.init(), u.Select2.init(), u.Dropzone.init(), u.Slider.init(), u.DataTable.init();
        }),
        (u.TGL.init = function () {
            u.TGL.content(".toggle"), u.TGL.expand(".toggle-expand"), u.TGL.expand(".toggle-opt", { toggle: !1 }), u.TGL.showmenu(".nk-nav-toggle"), u.TGL.ddmenu("." + t + "-toggle", { self: t + "-toggle", child: t + "-sub" });
        }),
