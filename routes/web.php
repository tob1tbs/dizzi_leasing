...
Route::group(['prefix' => LaravelLocalization::setLocale(), 'middleware' => ['web', 'localeSessionRedirect', 'localizationRedirect', 'localeViewPath']], function(){
    ...
    Route::get('/avtolombardi', [App\Http\Controllers\WebControllers\Leasing\LeasingController::class, 'actionWebBackLeasing'])->name('actionWebBackLeasing');
    ...
    Route::get('/avtolombardi/form', [App\Http\Controllers\WebControllers\Leasing\LeasingController::class, 'actionWebBackLeasingForm'])->name('actionWebBackLeasingForm');
...
Route::group(['prefix' => '/ajax'], function() {
    ...
    Route::get('/ajaxGetTaxiLoanData', [App\Http\Controllers\WebControllers\Leasing\LeasingAjaxController::class, 'ajaxGetTaxiLoanData'])->name('ajaxGetTaxiLoanData');
...
Route::group(['prefix' => '/cms'], function() {
    ...
    Route::group(['prefix' => '/ajax'], function() {
        ...
        Route::get('/ajaxUpdateOtherPhoto/', [App\Http\Controllers\CmsControllers\Parameters\ParametersAjaxController::class, 'ajaxUpdateOtherPhoto'])->name('ajaxUpdateOtherPhoto');
        ...
        Route::post('/ajaxBlogStatusChange/', [App\Http\Controllers\CmsControllers\Blog\BlogAjaxController::class, 'ajaxBlogStatusChange'])->name('ajaxBlogStatusChange');
        ...
        Route::post('/ajaxQuestionSubmit/', [App\Http\Controllers\CmsControllers\TextPage\TextPageAjaxController::class, 'ajaxQuestionSubmit'])->name('ajaxQuestionSubmit');
        Route::get('/ajaxEditQuestion/', [App\Http\Controllers\CmsControllers\TextPage\TextPageAjaxController::class, 'ajaxEditQuestion'])->name('ajaxEditQuestion');
        Route::post('/ajaxQuestionDelete/', [App\Http\Controllers\CmsControllers\TextPage\TextPageAjaxController::class, 'ajaxQuestionDelete'])->name('ajaxQuestionDelete');
