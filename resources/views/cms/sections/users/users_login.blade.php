                            ...
                            <div class="card-inner card-inner-lg">
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        <h4 class="nk-block-title font-helvetica-regular">ავტორიზაცია</h4>
                                        <div class="nk-block-des">
                                            <p class="font-neue" style="font-size: 13px;">სისტემაში შესასვლელად გთხოვთ გამოიყენოთ თქვენი ელ-ფოსტა და პაროლი</p>
                                        </div>
                                    </div>
                                </div>
                                <form action="{{ route('actionUsersLoginRequest') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            ...
                                            <a class="link link-primary link-sm font-neue" href="{{ route('actionUsersReset') }}">დაგავიწყდა პაროლი?</a>
                                        </div>
                                        <div class="form-control-wrap">
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-lg btn-primary btn-block font-helvetica-regular" type="submit">ავტორიზაცია</button>
                                    </div>
                                </form>
                            </div>
                        </div>
