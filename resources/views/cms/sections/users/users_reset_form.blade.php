                                ...
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="font-neue" style="font-size: 13px;">გთხოვთ შეივანოთ თქვენი ახალი პაროლი</p>
                                        </div>
                                    </div>
                                </div>
                                <form action="{{ route('actionUsersResetFormSubmit') }}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control form-control-lg" name="email" value="{{ request()->email }}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            <label class="form-label" for="default-01">ახალი პაროლი</label>
                                        </div>
                                        <div class="form-control-wrap">
                                    ...
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            <label class="form-label" for="default-01">გთხოვთ გაიმეოროთ პაროლი</label>
                                        </div>
                                        <div class="form-control-wrap">
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-lg btn-primary btn-block font-helvetica-regular" type="submit">განახლება</button>
                                    </div>
