...
<div class="header-menu header-menu-4" id="sticky">
    <nav class="navbar navbar-expand-lg navbar-light" style="padding: 15px 0 !important;">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown submenu">
                        <a class="theme-btn theme-btn-rounded-2 theme-btn-alt neue custom-button-color" href="#0" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="padding: 0 25px; font-size: 15px; position: relative; left: 15px;">{{ trans('site.get_loan') }}</a>
