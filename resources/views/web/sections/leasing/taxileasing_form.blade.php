                                ...
                                <div class="loan-details-widget bg_white">
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id='lName' class="form-control" type="tel" pattern="[0-9]{9}" maxlength="11" name="user_personal_number">
                                        </div>
                                        <div class="col-md-6">
                    ...
                    <div class="col-lg-4 ps-xl-5 mt-5 mt-lg-0">
                        <div class="blog-sidebar-widget ps-lg-2">
                            <div class="widget-subscribe" style="padding: 30px 20px 40px 20px;">
                                ...
                                <br>
                                <img src="{{ url('assets/web/img\icon\next.png') }}">
                                <a href="{{ url('uploads/documents/'.$parameterItems['document_file'][0]) }}" target="_blank" style="font-size: 16px; text-decoration: underline; color: #f0c019;">{{ trans('site.information') }}</a>
                            </div>
