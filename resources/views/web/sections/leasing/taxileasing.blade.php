                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-8 col-xl-8 helvetica-regular">
                            <p>თუ გსურს, რომ შენი ყოველდღიური შრომით გამოიუმუშავო თანხა და ამისთვის გჭირდება მანქანა, (ან უკვე ფლობ ავტომობილს და გსურს შეცვალო უკეთესით) შეავსე <b>განაცხადი</b> და 10 წუთში მიიღებ პასუხს.&nbsp;</p><br><br><p>თუ შენი მონაცემები აკმაყოფილებს ჩვენ მოთხოვნებს, წინასწარ დაგიმტკიცებთ შეფასების მინიმუმ 80%-ს.&nbsp;</p><br><br><p>Შემდეგ მოდი მანქანის მფლობელთან ერთად ჩვენ ნებისმიერ <b>ფილიალში</b> (თან გქონდეს პირადობის მოწმობა, მართვის მოწმობა და მანქანის ტექპასპორტი), რათა შემფასებელმა გადაამოწმოს მანქანის მდგომარეობა.</p><br><br><p>თუ დამტკიცებული თანხა შენთვის მისაღებია, სულ მოგიწევს 3 რამის გაკეთება:</p><br><br><p></p><ul><li>აარჩევ სასურველი გადახდის გრაფიკს და ხელს მოაწერ კონტრაქტს</li><li>შემოიტან თანამონაწილეობას (მაგალითად, თუ დაგიმტკიცდა ღირებულების 90% - დარჩენილ 10%-ს), ხოლო ჩვენ სრულ თანხას გადავურიცხავთ მანქანის მეპატრონეს.</li><li>მანქანას გადმოაფორმებ “დიზი” ლიზინგის სახელზე</li></ul><br><br><p></p><br><p>Მორჩა, ტაქსი ლიზინგი გაკეთებულია და შენ უკვე ახალი შემოსავლის წყარო გაქვს!</p><br>
                        </div>
                    </div>
                </div>
            </div>
