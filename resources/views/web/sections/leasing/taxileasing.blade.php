                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-sm-12 col-lg-4 col-xl-4">
                            <img src="{{ url('assets/web/img/banner/taxileasing_banner.jpg') }}" class="img-fluid" style="border-radius: 10px;">
                        </div>
                        <div class="col-sm-12 col-lg-8 col-xl-8 helvetica-regular">
                            <p>
                                ...
                                შემდეგ მოდი ჩვენს ნებისმიერ <a href="{{ route('actionWebContact') }}" style="font-weight: bold;">ფილიალში</a> (თან გქონდეს პირადობა ან მართვის მოწმობა, მანქანის ტეპასპორტი და რასაკვრიველია - თვითონ მანქანაც), რათა შემფასებელმა გადაამოწმოს მანქანის მდგომარეობა და შეადაროს მოთხოვნილი თანხა რეალურ ღირებულებას. <br>
                                ...
                                თუ გსურს, რომ შენი ყოველდღიური შრომით გამოიუმუშავო თანხა და ამისთვის გჭირდება მანქანა, (ან უკვე ფლობ ავტომობილს და გსურს შეცვალო უკეთესით) შეავსე <a href="#form_block" style="font-weight: bold;">განაცხადი</a> და 10 წუთში მიიღებ პასუხს. <br>
                                თუ ავტომობილი და შენი პერსონალური მონაცემები აკმაყოფილებს კომპანიის მოთხოვნებს, ჩვენ ონლაინ დაგიმტკიცებთ შეფასების 90%-ს. <br>
                                შემდეგ მოდი მანქანის მფლობელთან ერთად ჩვენს ნებისმიერ <a href="{{ route('actionWebContact') }}" style="font-weight: bold;">ფილიალში</a> (თან გქონდეს პირადობა ან მართვის მოწმობა და მანქანის ტექ.პასპორტი), რათა შემფასებელმა გადაამოწმოს მანქანის მდგომარეობა და შეადაროს მოთხოვნილი თანხა რეალურ ღირებულებას. <br>
                                თუ დამტკიცებული თანხა შენთვის მისაღებია, სულ მოგიწევს 3 რამის გაკეთება: <br>
                                •   მოაწერ ხელს კონტრაქტს <br>
                                •   მანქანას გადმოაფორმებ ჩვენ კომპანიაზე <br>
                                •   შემოიტან თანამონაწილეობას (მაგალითად, თუ ღირებულების 90% დაგიმტკიცდა - დარჩენილ 10%-ს) ხოლო ჩვენ, სრულ თანხას გადავურიცხავთ მანქანის მეპატრონეს.<br>
                                მორჩა, ლიზინგი გაკეთებულია და შენ უკვე ახალი მანქანა გყავს!
...
@section('js')
<script type="text/javascript" src="{{ url('assets/web/js/taxi_calculate.js') }}"></script>
