                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-8 col-xl-8 helvetica-regular">
                            <p>
                                ...
                                შემდეგ მოდი მანქანის მფლობელთან ერთად ჩვენს ნებისმიერ <a href="{{ route('actionWebContact') }}" style="font-weight: bold;" target="_blank">ფილიალში</a> (თან გქონდეს პირადობა ან მართვის მოწმობა და მანქანის ტექ.პასპორტი), რათა შემფასებელმა გადაამოწმოს მანქანის მდგომარეობა და შეადაროს მოთხოვნილი თანხა რეალურ ღირებულებას. <br>
                                ...
                                •   შემოიტან თანამონაწილეობას (მაგალითად, თუ ღირებულების 80% დაგიმტკიცდა - დარჩენილ 10%-ს) ხოლო ჩვენ, სრულ თანხას გადავურიცხავთ მანქანის მეპატრონეს.<br>
