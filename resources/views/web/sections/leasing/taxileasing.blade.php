                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-sm-12 col-lg-4 col-xl-4">
                            <img src="{{ url('uploads/other/'.$otherPhotos['5'][0]) }}" class="img-fluid" style="border-radius: 10px;">
                        </div>
                        ...
                        <div class="calculator-result-widget bg_disable wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div id="terms" style="margin-top: 15px; width: 100%; float: left;">
	                            ...
	                            <label for="terms" class="helvetica-regular" style="font-size: 14px; float: left; width: 100%; margin-left: 15px;"> {{ trans('site.accept_marketing') }}
                                    ...
                                    <br><a href="{{ url('uploads/documents/'.$parameterLeasing['document_file'][0]) }}" target="_blank" style="font-size: 16px; text-decoration: underline; color: #f0c019;">{{ trans('site.information') }}</a>
	                            </label>
                            </div>
