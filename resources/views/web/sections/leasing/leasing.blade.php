                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-8 col-xl-8">
                            <p>გამოგვიგზავნე <strong>განაცხადი</strong> და ჩვენი ქოლ ცენტრი მყისიერად დაგიკავშირდება. ჩაიწერს შენს მონაცემებს, გადაამოწმებს საკრედიტო ისტორიას და 15 წუთში დაგიბრუნებს პასუხს. თუ საკრედიტო ისტორია აკმაყოფილებს ჩვენს მოთხოვნებს, ჩვენ ონლაინ დაგიმტკიცებთ შეფასების მინიმუმ 80%-ს. Შემდეგ მოდი მანქანის მფლობელთან ერთად ჩვენს <strong>ნებისმიერ</strong>  (თან გქონდეს პირადობა, მართვის მოწმობა და მანქანის ტეპასპორტი), რათა შემფასებელმა გადაამოწმოს მანქანის მდგომარეობა და შეადაროს მოთხოვნილი თანხა რეალურ ღირებულებას. Თუ ავტომობილის მდგომარეობა კარგია, ჩვენ რამოდენიმე წუთში გეტყვით საბოლოო პასუხს - რა თანხა დაგიმტკიცდა.&nbsp;</p><p><strong></strong></p> <p>Თუ დამტკიცებული თანხა შენთვის მისაღებია, სულ მოგიწევს 3 რამის გაკეთება:</p><p></p><ul><li>Აარჩევ სასურველი გადახდის გრაფიკს და ხელს მოაწერ კონტრაქტს</li><li>მანქანას გადმოაფორმებ ჩვენ კომპანიაზე</li><li>შემოიტან თანამონაწილეობას (მაგალითად, თუ დაგიმტკიცდა ღირებულების 80% - დარჩენილ 20%-ს), ხოლო ჩვენ სრულ თანხას გადავურიცხავთ მანქანის მეპატრონეს.&nbsp;</li></ul><p></p><p>Მორჩა, ლიზინგი გაკეთებულია და შენ უკვე ახალი მანქანა გყავს!&nbsp;</p><br>
                        </div>
                    </div>
                </div>
            </div>
