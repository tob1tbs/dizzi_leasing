                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-8 col-xl-8 helvetica-regular">
                            <p>
                                თუ გსურს მანქანის შეძენა, მაგრამ გაკლდება თანხა, გამოგვიგზავნე <a href="#">განაცხადი</a> და ჩვენი „ქოლ ცენტრი“ 5 წუთში დაგიკავშირდება.<br> 
                                ...
                                შემდეგ მოდი მანქანის მფლობელთან ერთად ჩვენს ნებისმიერ <a href="{{ route('actionWebContact') }}">ფილიალში</a> (თან გქონდეს პირადობა ან მართვის მოწმობა და მანქანის ტექ.პასპორტი), რათა შემფასებელმა გადაამოწმოს მანქანის მდგომარეობა და შეადაროს მოთხოვნილი თანხა რეალურ ღირებულებას. <br> 
