                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-8 col-xl-8 helvetica-regular">
                            <p>გამოგვიგზავნე <b>განაცხადი</b> და ჩვენი ქოლ ცენტრი მყისიერად დაგიკავშირდება. ჩაიწერს შენს მონაცემებს, გადაამოწმებს საკრედიტო ისტორიას და 15 წუთში დაგიბრუნებს პასუხს. თუ საკრედიტო ისტორია აკმაყოფილებს ჩვენს მოთხოვნებს, ჩვენ ონლაინ დაგიმტკიცებთ შეფასების მინიმუმ 80%-ს. Შემდეგ მოდი მანქანის მფლობელთან ერთად ჩვენს <b>ნებისმიერ</b>  (თან გქონდეს პირადობა, მართვის მოწმობა და მანქანის ტეპასპორტი), რათა შემფასებელმა გადაამოწმოს მანქანის მდგომარეობა და შეადაროს მოთხოვნილი თანხა რეალურ ღირებულებას. Თუ ავტომობილის მდგომარეობა კარგია, ჩვენ რამოდენიმე წუთში გეტყვით საბოლოო პასუხს - რა თანხა დაგიმტკიცდა.&nbsp;</p><br><p><b></b></p> <p>Თუ დამტკიცებული თანხა შენთვის მისაღებია, სულ მოგიწევს 3 რამის გაკეთება:</p><br><p></p><p></p><p>Მორჩა, ლიზინგი გაკეთებულია და შენ უკვე ახალი მანქანა გყავს!&nbsp;</p><br>
                        </div>
                    </div>
