                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="desc-text pl-lg-10 helvetica-regular">
                            <h4 class="neue">{{ $page_data->title }}</h4>
                            <p class="mt-35 helvetica-regular">კომპანია „დიზი“ დაარსებულია და იმართება საერთაშორისო ავტო სალიზინგო ბაზარზე მრავალწლიანი გამოცდილების მქონე პროფესიონალთა გუნდის მიერ.
                            </p>
                            <p class="mt-20 helvetica-regular">ჩვენი მიზანია, მოკლე ვადაში, გავხდეთ ერთ-ერთი წამყვანი სალიზინგო კომპანია საქართველოს ბაზარზე თანამედროვე ტექნოლოგიების დანერგვის დახმარებით, რომელიც საშუალებას გვაძლევს გავუწიოთ მომხმარებლებს უმაღლესი ხარისხის მომსახურეობა, რომელიც დაეყრდნობა ადამიანურ ღირებულებებსა და გულახდილობის პრინციპებს.
                            </p>
                        </div>
                    </div>
                </div>
