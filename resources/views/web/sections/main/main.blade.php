						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-4 col-sm-12">
								<div class="wow fadeInUp" data-wow-delay="0.3s" style="border-radius: 6px; padding-bottom: 4px;">
									...
									<ul class="service helvetica-regular">
			                            ...
			                            <hr>
                                        <li><span class="d-block d-xxl-none d-xl-none"><b>{{ trans('site.insurance') }}</b></span> {{ trans('site.insurance_value') }}</li>
			                            <hr>
                                        <li><span class="d-block d-xxl-none d-xl-none"><b>{{ trans('site.income_verification') }}</b></span> {{ trans('site.income_verification_value') }}</li>
			                            <hr>
							...
							<div class="col-lg-3 col-md-4 col-sm-12">
								<div class="wow fadeInUp" data-wow-delay="0.3s" style="border-radius: 6px; padding-bottom: 4px;">
			                        ...
			                        <ul class="service helvetica-regular">
                                        @if(Session::get('locale') == 'ge')
                                        <li><span class="d-block d-xxl-none d-xl-none"><b>{{ trans('site.min_price') }}</b></span> {{ number_format($parameterLeasing['back_leasing_min_price'][0], '0', '.', ',') }} {{ trans('site.to_gel') }} </li>
                                        @else
                                        <li><span class="d-block d-xxl-none d-xl-none"><b>{{ trans('site.min_price') }}</b></span> From {{ number_format($parameterLeasing['back_leasing_min_price'][0], '0', '.', ',') }} {{ trans('site.to_gel') }} </li>
                                        @endif
                                        <hr>
                                        @if(Session::get('locale') == 'ge')
                                        <li><span class="d-block d-xxl-none d-xl-none"><b>{{ trans('site.max_price') }}</b></span> {{ number_format($parameterLeasing['back_leasing_max_price'][0], '0', '.', ',') }} {{ trans('site.to_gel') }} </li>
                                        @else
                                        <li><span class="d-block d-xxl-none d-xl-none"><b>{{ trans('site.max_price') }}</b></span> To {{ number_format($parameterLeasing['back_leasing_max_price'][0], '0', '.', ',') }} {{ trans('site.to_gel') }} </li>
                                        @endif
                                        <hr>
                                        <li><span class="d-block d-xxl-none d-xl-none"><b>{{ trans('site.max_month') }}</b></span> {{ $parameterLeasing['leasing_max_month'][0] }} {{ trans('site.month') }}</li>
                                        <hr>
                                        <li><span class="d-block d-xxl-none d-xl-none"><b>{{ trans('site.initial_deposit') }}</b></span> -</li>
                                        <hr>
                                        <li><span class="d-block d-xxl-none d-xl-none"><b>{{ trans('site.credit_history') }}</b></span> {{ trans('site.credit_hostory_value') }}</li>
                                        <hr>
                                        <li><span class="d-block d-xxl-none d-xl-none"><b>{{ trans('site.insurance') }}</b></span> {{ trans('site.insurance_value') }}</li>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-12">
                                <div class="wow fadeInUp" data-wow-delay="0.3s" style="border-radius: 6px; padding-bottom: 4px;">
                                    ...
                                    <ul class="service helvetica-regular">
                                        @if(Session::get('locale') == 'ge')
                                        <li><span class="d-block d-xxl-none d-xl-none"><b>{{ trans('site.min_price') }}</b></span> {{ number_format($parameterLeasing['taxi_leasing_min_price'][0], '0', '.', ',') }} {{ trans('site.to_gel') }} </li>
                                        @else
                                        <li><span class="d-block d-xxl-none d-xl-none"><b>{{ trans('site.min_price') }}</b></span> From {{ number_format($parameterLeasing['taxi_leasing_min_price'][0], '0', '.', ',') }} {{ trans('site.to_gel') }} </li>
                                        @endif
                                        <hr>
                                        @if(Session::get('locale') == 'ge')
                                        <li><span class="d-block d-xxl-none d-xl-none"><b>{{ trans('site.max_price') }}</b></span> {{ number_format($parameterLeasing['taxi_leasing_max_price'][0], '0', '.', ',') }} {{ trans('site.to_gel') }} </li>
                                        @else
                                        <li><span class="d-block d-xxl-none d-xl-none"><b>{{ trans('site.max_price') }}</b></span> To {{ number_format($parameterLeasing['taxi_leasing_max_price'][0], '0', '.', ',') }} {{ trans('site.to_gel') }} </li>
                                        @endif
                                        <hr>
                                        <li><span class="d-block d-xxl-none d-xl-none"><b>{{ trans('site.max_month') }}</b></span> {{ $parameterLeasing['leasing_max_month'][0] }} {{ trans('site.month') }}</li>
                                        <hr>
                    ...
                    <div class="card-img mb-5 mb-sm-0">
                        <div class="shape-1">
                            <img class="wow fadeInLeft" data-wow-delay="1.2s" data-depth="0.2"
                                src="{{ url('uploads/step/'.$step_list[1]) }}" alt="card" style="border-radius: 10px; box-shadow: 0 0.5px 1px 0 rgb(51 77 114 / 50%), 0px 1.6px 3.6px 0 rgb(51 77 114 / 15%); transition: all 0.3s ease-out;">
                        </div>
                        <div class="shape-2">
                            <img class="wow fadeInRight" data-wow-delay="1s" data-depth="0.3"
                                src="{{ url('uploads/step/'.$step_list[2]) }}" alt="card" style="border-radius: 10px; box-shadow: 0 0.5px 1px 0 rgb(51 77 114 / 50%), 0px 1.6px 3.6px 0 rgb(51 77 114 / 15%); transition: all 0.3s ease-out;">
                        </div>
                        <div class="shape-3">
                            <img class="wow fadeInLeft" data-wow-delay="1.2s" data-depth="0.2" src="{{ url('uploads/step/'.$step_list[3]) }}"
                        ...
                        <div class="shape-4">
                            <img class="wow fadeInRight" data-wow-delay="1s" data-depth="0.3" src="{{ url('uploads/step/'.$step_list[4]) }}"
                                alt="card" style="border-radius: 10px; box-shadow: 0 0.5px 1px 0 rgb(51 77 114 / 50%), 0px 1.6px 3.6px 0 rgb(51 77 114 / 15%); transition: all 0.3s ease-out;">
                        </div>
                    </div>
                </div>
