							...
							<div class="col-lg-3 col-md-4 col-sm-12">
								<div class="wow fadeInUp" data-wow-delay="0.3s" style="border-radius: 6px; padding-bottom: 4px;">
									...
									<ul class="service helvetica-regular">
                                        ...
                                        <li><span class="d-block d-xxl-none d-xl-none">{{ trans('site.min_price') }}</span> {{ number_format($parameterLeasing['leasing_min_price'][0], '0', '.', ',') }} {{ trans('site.to_gel') }} </li>
                                        @else
                                        <li><span class="d-block d-xxl-none d-xl-none">{{ trans('site.min_price') }}</span> From {{ number_format($parameterLeasing['leasing_min_price'][0], '0', '.', ',') }} {{ trans('site.to_gel') }} </li>
                                        @endif
                                        <hr>
										@if(Session::get('locale') == 'ge')
			                            <li><span class="d-block d-xxl-none d-xl-none">{{ trans('site.max_price') }}</span> {{ number_format($parameterLeasing['leasing_max_price'][0], '0', '.', ',') }} {{ trans('site.to_gel') }} </li>
			                            @else
			                            <li><span class="d-block d-xxl-none d-xl-none">{{ trans('site.max_price') }}</span> To {{ number_format($parameterLeasing['leasing_max_price'][0], '0', '.', ',') }} {{ trans('site.to_gel') }} </li>
			                            @endif
			                            <hr>
			                            <li><span class="d-block d-xxl-none d-xl-none">{{ trans('site.max_month') }}</span> {{ $parameterLeasing['leasing_max_month'][0] }} {{ trans('site.month') }}</li>
			                            <hr>
			                            <li><span class="d-block d-xxl-none d-xl-none">{{ trans('site.initial_deposit') }}</span> {{ trans('site.minimum') }}: {{ $parameterLeasing['leasing_avanse_min_percent'][0] }}%</li>
			                            <hr>
			                            <li><span class="d-block d-xxl-none d-xl-none">{{ trans('site.credit_history') }}</span> {{ trans('site.credit_hostory_value') }}</li>
			                            <hr>
                                        <li><span class="d-block d-xxl-none d-xl-none">{{ trans('site.insurance') }}</span> {{ trans('site.insurance_value') }}</li>
			                            <hr>
                                        <li><span class="d-block d-xxl-none d-xl-none">{{ trans('site.income_verification') }}</span> {{ trans('site.income_verification_value') }}</li>
			                            <hr>
			                            <li><span class="d-block d-xxl-none d-xl-none">{{ trans('site.documents') }}</span> {{ trans('site.documents_value') }}</li>
			                        </ul>
							...
							<div class="col-lg-3 col-md-4 col-sm-12">
								<div class="wow fadeInUp" data-wow-delay="0.3s" style="border-radius: 6px; padding-bottom: 4px;">
			                        ...
			                        <ul class="service helvetica-regular">
                                        ...
                                        <li><span class="d-block d-xxl-none d-xl-none">{{ trans('site.max_month') }}</span> {{ $parameterLeasing['leasing_max_month'][0] }} {{ trans('site.month') }}</li>
                                        <hr>
                                        <li><span class="d-block d-xxl-none d-xl-none">{{ trans('site.initial_deposit') }}</span> -</li>
                                        <hr>
                                        <li><span class="d-block d-xxl-none d-xl-none">{{ trans('site.credit_history') }}</span> {{ trans('site.credit_hostory_value') }}</li>
                                        <hr>
                                        <li><span class="d-block d-xxl-none d-xl-none">{{ trans('site.insurance') }}</span> {{ trans('site.insurance_value') }}</li>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-12">
                                <div class="wow fadeInUp" data-wow-delay="0.3s" style="border-radius: 6px; padding-bottom: 4px;">
                                    ...
                                    <ul class="service helvetica-regular">
                                        ...
                                        <li><span class="d-block d-xxl-none d-xl-none">{{ trans('site.max_month') }}</span> {{ $parameterLeasing['leasing_max_month'][0] }} {{ trans('site.month') }}</li>
                                        <hr>
                                        <li><span class="d-block d-xxl-none d-xl-none">{{ trans('site.initial_deposit') }}</span> {{ trans('site.minimum') }}: {{ $parameterLeasing['leasing_avanse_min_percent_taxi'][0] }}%</li>
                                        <hr>
                                        <li><span class="d-block d-xxl-none d-xl-none">{{ trans('site.credit_history') }}</span> {{ trans('site.credit_hostory_value') }}</li>
                                        <hr>
                                        <li><span class="d-block d-xxl-none d-xl-none">{{ trans('site.insurance') }}</span> {{ trans('site.insurance_value') }}</li>
