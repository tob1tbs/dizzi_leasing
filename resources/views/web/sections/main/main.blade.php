				...
				<div class="col-xl-12 col-md-12">
					...
					<div class="feature-card-widget wow fadeInUp" data-wow-delay="0.6s" id="about" style="margin-top: 35px; padding: 30px;">
						...
						<p id="abouttext" class="helvetica-regular">
                            ...
                            შეავსებ <a href="{{ route('actionWebLeasing') }}">ონლაინ</a> განაცხადს, დადებითი პასუხის შემთხვევაში კი მანქანის მფლობელთან ერთად მიხვალ <a href="{{ route('actionWebContact') }}">ფილიალში</a>, რომ შემოწმდეს ავტომობილის მდგომარეობა. 
