                    ...
                    <div class="card-img mb-5 mb-sm-0">
                        <div class="shape-1">
                            <img class="wow fadeInLeft" data-wow-delay="1.2s" data-depth="0.2"
                                src="{{ url('assets/web/img/banner/step_2.png') }}" alt="card" style="border-radius: 10px; box-shadow: 0 0.5px 1px 0 rgb(51 77 114 / 10%), 0px 1.6px 3.6px 0 rgb(51 77 114 / 15%); transition: all 0.3s ease-out;">
                        </div>
                        <div class="shape-2">
                            <img class="wow fadeInRight" data-wow-delay="1s" data-depth="0.3"
                                src="{{ url('assets/web/img/banner/step_1.png') }}" alt="card" style="border-radius: 10px; box-shadow: 0 0.5px 1px 0 rgb(51 77 114 / 10%), 0px 1.6px 3.6px 0 rgb(51 77 114 / 15%); transition: all 0.3s ease-out;">
                        </div>
                        <div class="shape-3">
                            <img class="wow fadeInLeft" data-wow-delay="1.2s" data-depth="0.2" src="{{ url('assets/web/img/banner/step_3.png') }}"
                                alt="card" style="border-radius: 10px; box-shadow: 0 0.5px 1px 0 rgb(51 77 114 / 10%), 0px 1.6px 3.6px 0 rgb(51 77 114 / 15%); transition: all 0.3s ease-out;">
                        </div>
                        <div class="shape-4">
